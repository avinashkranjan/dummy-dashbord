  ...
  return (
    <nav className="navbar">
      <div className="flex flex-no-wrap">
        <div>
          <div className="pl-72 w-screen justify-between flex-1 flex flex-col">
            <nav className="px-4 flex justify-between bg-white h-16">
              <form className="w-[44rem] mt-2">
                <label
          ...
          <div className="-mt-16 w-72 absolute sm:relative bg-gray-200 shadow md:h-screen flex-col justify-between hidden sm:flex">
            <div className="px-8">
              ...
              <ul className="mt-10">
                <li className="flex w-full justify-between text-gray-900 hover:text-gray-500 cursor-pointer items-center mb-6">
