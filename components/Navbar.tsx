...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="navbar">
      <div className="flex flex-no-wrap">
        <div className="w-72 absolute sm:relative bg-gray-200 shadow md:h-screen flex-col justify-between hidden sm:flex">
          <div className="px-4">
            ...
            <ul className="mt-10">
              <li className="flex w-full justify-between text-gray-900 hover:text-gray-500 cursor-pointer hover:bg-slate-300 p-2 rounded items-center mb-3">
              ...
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 hover:bg-slate-300 p-2 rounded cursor-pointer items-center mb-3">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-3 hover:bg-slate-300 p-2 rounded">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-puzzle"
              ...
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center">
                <div
                  className="flex items-center hover:bg-slate-300 p-2 rounded"
              ...
              <ul className={`${isSettingsOpen ? "" : "hidden"} ml-10 text-sm`}>
                <li className="py-2 flex hover:bg-slate-300 p-2 rounded hover:cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <li
                  className="py-2 flex hover:bg-slate-300 p-2 rounded hover:cursor-pointer"
                  onClick={logOut}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="px-8 border-t border-gray-300">
            <ul className="w-full flex items-center justify-between bg-gray-200">
              <li className="cursor-pointer text-black pt-5 pb-3 hover:bg-gray-400 hover:p-2 hover:rounded-full hover:text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <div
          className="h-10 w-10 bg-gray-200 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
          id="mobile-toggler"
        ...
        <div className="px-8">
          ...
          <ul className="mt-12">
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-3">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-puzzle"
